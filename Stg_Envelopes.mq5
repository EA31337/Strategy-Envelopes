...
// Inputs.
INPUT_GROUP("Envelopes strategy: main");
...
// Includes strategy.
#include "Stg_Envelopes.mqh"

// Defines.
#define ea_name "Strategy Envelopes"
#define ea_version "1.010"
#define ea_desc "Strategy based on EA31337 framework."
#define ea_link "https://github.com/EA31337/Strategy-Envelopes"
...
int OnInit() {
  ...
  ea = new EA(ea_params);
  _result &= ea.StrategyAdd<Stg_Envelopes>(Active_Tfs);
